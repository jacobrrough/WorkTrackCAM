          ...
          <li key={op.id} className={selectedOpIndex === i ? 'manufacture-op-li manufacture-op-li--selected' : 'manufacture-op-li'}>
            ...
            {op.kind === 'fdm_slice' ? (
              <div className="msg manufacture-op-hint">
                <p>
                  Not generated by <strong>Generate CAM</strong>. Run the slicer from the <strong>Slice</strong> tab here or use{' '}
                  <strong>Slice with OrcaSlicer</strong> below (uses <strong>source mesh</strong> + merged slice
                  profiles from Settings). G-code is unverified until you
